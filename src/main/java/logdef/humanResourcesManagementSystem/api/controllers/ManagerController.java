...
public class ManagerController {
	...
	@GetMapping("/getall")
	public DataResult<List<Manager>> getAll(@RequestParam(value = "pageNo") int pageNo, @RequestParam(value = "pageSize") int pageSize) {
		return this.managerService.getAll(pageNo, pageSize);
	}
	
	@GetMapping("/getByEmployeeId")
	public DataResult<Manager> getByEmployeeId(@RequestParam(value = "employeeId") int employeeId) {
		return this.managerService.getByEmployeeId(employeeId);
	}
	...
	public Result deleteByAccountantId(@RequestParam(value = "employeeId") int employeeId) {
		return this.managerService.deleteByAccountantId(employeeId);
	}
