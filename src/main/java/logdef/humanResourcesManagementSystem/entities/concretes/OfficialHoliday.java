...
public class OfficialHoliday extends EventCalendar{
	
	@Column(name = "event_calendar_id")
	private int eventCalendarId;
	
	@Column(name="official_holiday_name")
	@NotEmpty(message = "Official holiday name field cannot be left blank..")
	private String officialHolidayName;
