...
public class ReligiousHoliday extends EventCalendar{
	
	@Column(name = "event_calendar_id")
	private int eventCalendarId;
	
	@Column(name="religious_holiday_name")
	@NotEmpty(message = "Religious holiday name field cannot be left blank..")
	private String religiouslHolidayName;
